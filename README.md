...
exam.ipynb: Contains all Process Mining code, from data cleaning (pre-processing) to performance analysis, process model discovery (Petri Net), and clinical variant analysis.
